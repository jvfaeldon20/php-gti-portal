                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="../../img/main/header-logo/gti_management.png" class="gti-logo">
                        </a>
                    </div>
                </div>
            </nav>
        ...
        <div class="row navbar-border">
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    ?>
                    <li class="link-margin"><a href="../main/management.php" class="active" data-toggle="tooltip" title="Management">MANAGEMENT</a></li>
                    <!--END OF MANAGEMENT-->
                </ul>
