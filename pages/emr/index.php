...
<body>
	<div class="container">
	 	...
	 	<?php
	 		...
	 		$stmt = 'SELECT  record_id AS count FROM record ORDER BY record_id DESC LIMIT 1';
	 	...
	 	<div class="row navbar-margin">
		 	<?php
		 		if (isset($_GET['create'])){
					if($_GET['create'] == 'ok'){
						echo"<div class = 'alert alert-success'><span class='glyphicon glyphicon-ok'></span>&nbsp&nbsp&nbspRecord successfully saved! <strong>Transaction No:&nbsp&nbsp".$row['count']."</strong></div>";

					}
					elseif(($_GET['create'] == 'misrouted')){
						echo"<div class='alert alert-warning'><span class='glyphicon glyphicon-import'></span>&nbsp&nbsp&nbsp<strong>1 Misrouted Call</strong> was successfully added to record!</div>";	
					}
					elseif(($_GET['create'] == 'transfer')){
						echo"<div class='alert alert-info'><span class='glyphicon glyphicon-transfer'></span>&nbsp&nbsp&nbsp<strong>1 Transfer to WR</strong> was successfully added to record!</div>";	
					}
					elseif(($_GET['create'] == 'hungup')){
						echo"<div class='alert alert-danger'><span class='glyphicon glyphicon-earphone'></span>&nbsp&nbsp&nbsp<strong>1 Hung up Call</strong> was successfully added to record!</div>";	
					}
					else{
	 		...
	 		<div class="col-md-3 section-left">
	 			<img src="<?php echo '../users/img/admin.jpg' ?>" class="img-circle user-photo">
		 			...
		 			<div class="">
						<a href="#" data-toggle="modal" data-target="#modal_new_transaction" class="userimg">
							<img src="..\..\img\emr\newcall.png" class="img-circle user-menu">
						</a>
						<img src="..\..\img\emr\history-2.png" class="img-circle user-menu2 userimg" >
	 		...
	 		<div class="col-md-8 section-right border-left">
	 			<form class="form-inline" method="POST" action="add_record.php">
	 				<input type="hidden" name="doctor_name" value="<?php echo $_COOKIE['first_name'].' '.$_COOKIE['last_name']; ?>">
	 					<div class="well well-sm well-bg"><i class="glyphicon glyphicon-user"></i>&nbsp&nbsp&nbsp
							<label class ="label-width label-emr">MEMBER INFORMATION</label>
						</div>
						<div class="row">
							<div class="col-lg-6">
								<label class ="label-width label-emr ">Membership</label>
									<input type="text" name="member_no" placeholder="MEMBERSHIP NO." class="form-control bs" id="member_no" required>
							</div>
							<div class="col-lg-6">
								<label class ="label-width label-emr">Caller Classification</label>	
								<select name="caller_classification" id="caller_classification" class="form-control bs no-border-radius caller_classification" required>
						...
						<div class="row">
							<div class="col-lg-6">
								<label class ="label-width label-emr ">Caller No.</label>
									<input type="text" name="caller_no" id="#caller_no" placeholder="ex. 09*********" class="form-control bs" maxlength="11" required>
							...
							<div class="col-lg-6">
								<label class ="label-width label-emr ">Sales Program</label>
									<input type="text" name="sales_program" id="sales_program" placeholder="SEARCH HERE >>" class="form-control sales_program bs" size="18px" autocomplete="off"  required>
									<a href="#" data-toggle="modal" data-target="#modal_sales_program"><i class="glyphicon glyphicon-search"></i>&nbsp&nbsp</a>
							</div>
						</div>
						<br>
						<!--CALLER INFORMATION-->
						...
						<div class="row">
							<div class="col-lg-6">
								<label class ="label-width label-emr ">First Name</label>
									<input type="text" name="first_name" id="first_name" class="form-control first_name bs"  required>
							</div>
							<div class="col-lg-6">
								<label class ="label-width label-emr ">Last Name</label>
									<input type="text" name="last_name" id="last_name" class="form-control last_name bs"  required>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-6">
							...
							<div class="col-lg-6">
								...
								<select name="gender" id="gender" class="form-control no-border-radius gender bs"  required>
						...
						<div class="row">
							<div class="col-lg-6">
								<label class ="label-width label-emr ">Municipality</label>
									<input type="text" name="municipality" id="location" placeholder="SEARCH HERE >>" class="form-control bs" size="18px" autocomplete="off" required>
						...
						<div class="row"><br>
								<div class="col-lg-6">
									...
									<select name="patient_classification" id="patient_classification" class="form-control patient_classification no-border-radius bs"  required>
										<option value="SUBSCRIBER">SUBSCRIBER</option>
						...
						<div class="row">
							...
							<div class="col-lg-6">
									<label class ="label-width label-emr ">RH</label>
										<select name="rh" id="rh" class="form-control no-border-radius vital rh"  required>
						...
						<div class="row">
							<div class="col-lg-12">
								<label class ="label-width label-emr ">Primary Chief Complaint/Symptoms</label><br>
									<input type="text" name="chief_complaint" id="symptoms" placeholder="SEARCH HERE >>" class="form-control textarea-symptoms chief_complaint" required>
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<div>
									...
									<label class ="label-width label-emr "><input type="radio" name="disease_type" id="disease_type" class="form-control disease_type disease_type" value="NON COMMUNICABLE" disabled="true" required>Non Communicable</label>
								</div>
							</div>
							<div class="col-lg-6">
								<label class ="label-width label-emr">Diseases</label>
								<div>
									<select name="diseases" id="diseases" class="form-control diseases no-border-radius" disabled="true" required>
						...
						<div class="row">
							<div class="col-lg-12">
								<label class ="label-width label-emr ">Service Call</label>
									<input type="text" name="service_call" id="service_call" placeholder="SEARCH HERE >>" class="form-control" size="38%" required>
					...
					<input type="submit" class="btn btn-emr pull-right btn-pd no-border-radius" value="Save">
					<a href="#" data-toggle="modal" data-target="#modal_summary" class="btn btn-emr pull-right btn-pd no-border-radius summary">Verify</a><br>
					<input type="hidden" name="ctime" id="ctime" class="form-control" value="<?php date_default_timezone_set('Asia/Manila'); echo date('g:i A'); ?>">
					...
					<input type="hidden" name="plan" 	 id="plan"     placeholder="plan" class="form-control">
					...
					<input type="hidden" name="region"   id="region"   placeholder="region" class="form-control">
